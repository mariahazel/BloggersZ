...
function printRelatedLabels_thumbs() {
	...
	while (i < relatedTitles.length && i < 20 && i < maxresults) {
		document.write('<a style="text-decoration:none;margin:0 10px 10px 0;float:left;background:#e6e6e6 url(//cdn.phimini.com/ColorRespMov/img/bar-bg.png) repeat-x top;border:1px solid #c9c9c9;');
